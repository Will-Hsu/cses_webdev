...
import Nabil from '../../images/nabil.jpg';
import Samvrit from '../../images/samvrit.jpeg';
...
import Yashil from '../../images/yashil.jpg';
import Cassandra from '../../images/cassandra.png';
import Sidhant from '../../images/sidhant.jpg';
...
import Anay from '../../images/anay.jpeg';
import Vinuthna from '../../images/vinuthna.jpg';
import Gloria from '../../images/gloria.jpg';
import Mishka from '../../images/mishka.jpeg';
import Delvin from '../../images/delvin.jpg';
import Sadrac from '../../images/sadrac.jpg';
import Joyce from '../../images/joyce.jpg';
...
import Jheel from '../../images/jheel.jpg';
...
return (
 <div style={{position: 'relative'}}>
  ...
  <Container maxWidth="xl" sx={styles.body}>
    ...
    <Grid container sx={{ marginTop: '4%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
     {isMiddleScreen && (
     ...
     {!isMiddleScreen && (
      ...
      <Grid container item xs={12} sm={15} md={12} justifyContent="center" sx={{ marginTop: { xs: '8%', sm: areFewMembers ? marginTopValue : '-90%', md: marginTopValue }, marginBottom: {xs: areFewMembers ? '10%' : '0%', sm: areFewMembers ? '10%' : '0%', md: areFewMembers ? '10%' : '0%'}}}>
